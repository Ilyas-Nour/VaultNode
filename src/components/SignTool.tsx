                        ...
                        {!signature ? (
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-3 bg-zinc-900 border border-white/5 rounded-lg space-y-1">
                                    <label className="text-[8px] font-black text-zinc-500 uppercase tracking-widest block">Placement Target</label>
                                    <p className="text-[10px] text-white font-mono">Page {selectedPage + 1} of {numPages}</p>
                                </div>
                                <button
                        ...
                        >
                            <div className="w-full max-w-lg aspect-video bg-zinc-900/50 border border-white/5 rounded-2xl flex flex-col items-center justify-center gap-4 text-center p-8">
                                ...
                                <div className="space-y-1">
                                    <p className="text-sm font-black text-white uppercase tracking-widest">Document Loaded</p>
                                    <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">{numPages} Pages Detected</p>
                                </div>
                                {!signature && (
                                    <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest leading-relaxed max-w-[240px]">
                                        Use the sidebar to draw your signature and place it on the document.
                                    </p>
                                )}
                                {signature && (
                                    <button
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-zinc-900/50">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-xs font-black text-white uppercase tracking-widest">Signing Workspace</h3>
                                            <p className="text-[9px] text-zinc-500 font-bold uppercase tracking-widest">Page {selectedPage + 1} of {numPages}</p>
                                        </div>
                                    </div>
                                    ...
                                    {numPages > 1 && (
                                        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-zinc-900/80 backdrop-blur-md border border-white/10 p-2 rounded-2xl">
                                            ...
                                            <div className="px-4 text-[11px] font-black text-white uppercase tracking-widest min-w-[100px] text-center">
                                                Page {selectedPage + 1} <span className="text-zinc-500">of {numPages}</span>
                                            </div>
                                            <button
                                ...
                                <div className="px-6 py-4 border-t border-white/5 bg-zinc-900/20 text-center">
                                    <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.2em]">
                                        Use the arrows to flip pages. Drag your signature to the precise spot.
                                    </p>
                                </div>
                            </motion.div>
                        </motion.div>
