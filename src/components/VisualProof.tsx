...
export function VisualProof({ toolId, mode = 'card', className }: VisualProofProps) {
            ...
            case 'compress':
                return (
                    <div className="relative w-full h-full rounded-lg overflow-hidden group/photo">
                        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&q=80&w=400')] bg-cover bg-center" />
                        ...
                        <div className={cn(
                            ...
                            {type === 'before' ? "HEAVY: 12.5 MB" : "OPTIMIZED: 0.8 MB"}
                        </div>
