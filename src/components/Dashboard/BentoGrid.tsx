                    ...
                    {filteredTools.map((tool, i) => (
                        ...
                        >
                            <Link href={tool.href} className="group block h-full">
                                <div className="h-full bg-zinc-900/30 border border-zinc-900 rounded-[2.5rem] p-8 lg:p-10 flex flex-col transition-all duration-500 hover:bg-zinc-900/50 hover:border-emerald-500/30 hover:shadow-2xl hover:shadow-emerald-500/5 group">
                                    <div className="flex items-start justify-between mb-8">
                                        <div className={cn(
                                            "w-16 h-16 rounded-2xl flex items-center justify-center shadow-2xl border transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 bg-zinc-950 border-zinc-800 text-zinc-400 group-hover:text-emerald-500 group-hover:border-emerald-500/50"
                                        )}>
