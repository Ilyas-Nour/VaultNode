...
// Dynamically import the heavy tool, turning off SSR to avoid server/browser mismatch with canvas APIs
const PdfToImgTool = dynamic(() => import("./PdfToImgTool"), {
    ssr: false,
...
export default function PdfToImgClient() {
    return <PdfToImgTool />;
}
