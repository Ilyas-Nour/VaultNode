        ...
        <>
            <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/[0.07]" style={{ background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(20px)' }}>
                <div className="w-full px-5 lg:px-10 h-14 flex items-center justify-between gap-6">
                    ...
                    <div ref={dropdownRef} className="hidden lg:flex items-center gap-0.5 xl:gap-1 flex-none justify-center">
                        ...
                        <Link href="/how-it-works" className="px-2 xl:px-3 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 hover:text-white transition-colors whitespace-nowrap">
                            {t('footer.linkHowItWorks')}
                        </Link>
                        
                        <Link href="/philosophy" className="px-2 xl:px-3 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 hover:text-white transition-colors whitespace-nowrap">
                            {t('footer.linkPhilosophy')}
                        </Link>

                        <Link href="/faq" className="px-2 xl:px-3 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-400 hover:text-white transition-colors whitespace-nowrap">
                            {t('nav.faq')}
                        </Link>

                        <div className="w-px h-4 bg-white/[0.08] mx-1 xl:mx-2" />

                        <Link href="/contact" className="px-3 xl:px-4 py-2 text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400 hover:text-zinc-200 transition-colors whitespace-nowrap">
                            {t('nav.contact')}
                        </Link>
                    </div>
